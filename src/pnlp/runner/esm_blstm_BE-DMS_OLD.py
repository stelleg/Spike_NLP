...
if __name__=='__main__':
    ...
    run_dir = os.path.join(results_dir, f"adam.lr{lr}.esm_blstm_BE-DMS_OLD-{date_hour_minute}")
    ...
    save_as = f"esm_blstm_BE-DMS_OLD_BE-train_{len(train_dataset)}_test_{len(test_dataset)}"
