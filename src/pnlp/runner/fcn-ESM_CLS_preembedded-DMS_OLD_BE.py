...
if __name__=='__main__':
    ...
    run_dir = os.path.join(results_dir, f"fcn-ESM_CLS_embedded-DMS_OLD_BE-{date_hour_minute}")
    ...
    train_dataset = DMSEmbeddedDataset_BE(os.path.join(data_dir, "parquets/mutation_combined_DMS_OLD_train_ESM-CLS-embedded.parquet"))
    ...
    test_dataset = DMSEmbeddedDataset_BE(os.path.join(data_dir, "parquets/mutation_combined_DMS_OLD_test_ESM-CLS-embedded.parquet"))
    ...
    save_as = f"fcn-ESM_CLS_embedded-DMS_OLD_BE-train_{len(train_dataset)}_test_{len(test_dataset)}"
