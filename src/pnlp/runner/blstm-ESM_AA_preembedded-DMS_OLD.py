...
if __name__=='__main__':
    ...
    run_dir = os.path.join(results_dir, f"adam.lr{lr}.blstm-ESM_AA_preembedded-DMS_OLD-{result_tag}-{date_hour_minute}")
    ...
    save_as = f"blstm-ESM_AA_preembedded-DMS_OLD_{result_tag}-train_{len(train_dataset)}_test_{len(test_dataset)}"
