#!/usr/bin/env python
"""
Model runner for BLSTM model using NLP BERT embeddings from ESM-init model (single target).
"""
import os
import re
import sys
...
if __name__=='__main__':
    ...
    run_dir = os.path.join(results_dir, f"blstm-NLP-DMS_OLD-{result_tag}-{date_hour_minute}")
    ...
    save_as = f"blstm-NLP-DMS_OLD_{result_tag}-train_{len(train_dataset)}_test_{len(test_dataset)}"
