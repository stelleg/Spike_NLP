...
if __name__=='__main__':
    ...
    run_dir = os.path.join(results_dir, f"blstm-ESM_AA-DMS_OLD_BE-{date_hour_minute}")
    ...
    save_as = f"blstm-ESM_AA-DMS_OLD_BE-train_{len(train_dataset)}_test_{len(test_dataset)}"
